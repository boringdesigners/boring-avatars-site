    ...
    <footer className="footer-wrapper">
      <p>
        ...
        <a href="https://hayk.design/">
          <Avatar square name="Hayk An" size="1em" colors={colors} />
          Hayk An
        </a>
        ,{' '}
        ...
        <a href="https://enric.dev/">
          <Avatar square name="Enric Pallerols" size="1em" colors={colors} />
          Enric Pallerols
        </a>{' '}
        and{' '}
      ...
      <p>
        The names used are from the <a href="https://notablewomen.withgoogle.com/all">Notable Women</a> project, the
        color palette samples are from the <a href="https://github.com/Jam3/nice-color-palettes">Nice Color Palettes</a>{' '}
        made by{' '}
